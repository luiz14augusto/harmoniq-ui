...
`;
export const Button = ({ variant = 'primary', isLoading, loadingLabel = 'Loading', children, ...rest }) => (_jsx(Base, { "$variant": variant, disabled: isLoading || rest.disabled, "aria-busy": !!isLoading, ...rest, children: _jsx("span", { children: isLoading ? loadingLabel : children }) }));
